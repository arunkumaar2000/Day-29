...
export default function EditStu() {
    ...
    useEffect(() => {
        fetch(`https://63ee2cfc388920150dda8023.mockapi.io/users/${userid}`, {
            method: "GET",
        })
            .then((data) => data.json())
            .then((usdata) => {
    ...
    return user ? <EditUserForm user={user} setUser={setUser} /> : <Spinner style={{ height: "50px", width: "50px" }} />
            ...
            <Button
                ...
                onClick={
                    () => {
                        ...
                        fetch(`https://63ee2cfc388920150dda8023.mockapi.io/users/${user.idno}`, {
                            method: "PUT",
